...
<nav class="navbar navbar-expand-md navbar-dark">
    <div class="container">
        <a href="admin_main.html" class="navbar-brand">E-Book-Library</a>
        ...
        <div id="main-nav" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                <li class="dropdown">
                    <a href="#" class="nav-item nav-link active">图书管理</a>
                    <div class="dropdown-menu">
                        <a href="admin_books.html" class="dropdown-item">全部图书</a>
                        <a href="admin_book_add.html" class="dropdown-item">新增图书</a>
                    </div>
                </li>
                <li class="dropdown">
                    <a href="#" class="nav-item nav-link" data-toggle="dropdown">读者管理</a>
                    <div class="dropdown-menu">
                        <a href="admin_readers.html" class="dropdown-item">全部读者</a>
                        <a href="admin_reader_add.html" class="dropdown-item">新增读者</a>
                    </div>
                </li>
                <li class="dropdown">
                    <a href="admin_lend_list.html" class="nav-item nav-link" data-toggle="dropdown">借还管理</a>
                    <div class="dropdown-menu">
                        <a href="admin_lend_list.html" class="dropdown-item">在借记录</a>
                        <a href="lend_history.html" class="dropdown-item">借阅历史</a>
                        <a href="admin_lend_list_add.html" class="dropdown-item">新增记录</a>
                        <a href="admin_bookings.html" class="dropdown-item">预约处理</a>
                    </div>
                </li>
                <li><a href="admin_fine.html" class="nav-item nav-link">罚款管理</a></li>
            </ul>
                    ...
                    <div class="dropdown-menu pull-right"
                        ...
                        <div style="margin-top: 16px;border-bottom: 1px solid #eeeeee">
                            ...
                            <div style="color: #323534;text-align: center;line-height: 36px;font-size: 15px">
                                <span>${USER_SESSION.user_email}</span>
                            </div>
                        </div>
...
<script>
    ...
    function passwordChange() {
        window.location.replace("admin_repasswd.html")
    }
